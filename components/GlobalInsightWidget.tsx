  ...
  return (
    <div className="w-full bg-white font-sans">
        <div className="py-6 md:py-10 md:pt-6 md:pb-12 px-4 md:px-10 md:mx-auto md:max-w-7xl flex flex-col space-y-6 md:space-y-12 justify-center items-center">
            <h2 className="md:w-1/2 text-xl md:text-[2.7rem] text-center font-black leading-tight"> <br/><span className="px-4 md:px-10 pt-3 pb-2 rounded-full bg-[#0E1A62] text-white">AnnanD EnterPrise</span></h2>
