  ...
  return (
    <div className="pb-10 sm:pb-0 sm:px-10 sm:min-h-48 sm:min-w-[27rem] flex flex-col justify-start space-y-6 border-b-4 sm:border-b-0 sm:border-r-4 border-dashed border-white">
        <div className="flex flex-col justify-start space-y-3 sm:space-y-6">
            ...
            <div className="flex items-center space-x-1 ">
                <span className="text-lg font-bold underline">Discover Our Stories and Impact</span>
                <MdPlayArrow className="h-6 w-6"/>
            </div>
            <div className="flex items-center space-x-1 ">
                <span className="text-lg font-bold underline">Fundraise for ACO</span>
                <MdPlayArrow className="h-6 w-6"/>
            </div>
            <div className="flex items-center space-x-1 ">
        ...
        <div className="px-6 py-3 w-48 bg-[#EE3E02] flex items-center justify-center space-x-2">
            <span className="text-white text-lg font-bold tracking-wider">Donate</span>
